...
x1_concentration_grad, x2_concentration_grad = np.gradient(np.where(toropogical_space_concentration > max_value, max_value, toropogical_space_concentration), DELTA_x1, DELTA_x2)
